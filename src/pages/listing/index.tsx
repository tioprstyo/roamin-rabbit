        ...
        <div className='main-wrapper max-w-screen-md mx-auto'>
            ...
            <div className='content-wrapper p-4 bg-[#FFF7DA]'>
                <div className='form-content'>
                    ...
                    <div className="form">
                        <button className="bg-white color-[#000000] font-extrabold uppercase text-sm px-4 py-4 rounded-[9px] mr-1 mb-1 w-full text-[14px] border border-[#E3E3E3]" type="button">
                            Filter
                        </button>
                    </div>
                </div>
