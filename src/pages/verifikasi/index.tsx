                ...
                <div className='form-content mt-5'>
                    <div className="form mb-6 flex flex-col gap-2">
                        ...
                        <div className="timer mt-3">
                            <p className='text-[16px] text-[#363636] font-normal'>Wait for <b className='text-[#40B7B0]'>02:59</b> to resend the OTP</p>
                        </div>
                    </div>
                    <div className="form">
                        <button onClick={handleOtpSubmit} disabled={isButtonDisabled} className="bg-[#FFEC69] color-[#000000] font-extrabold uppercase text-sm px-4 py-4 rounded-[9px] mr-1 mb-1 w-full text-[14px] disabled:bg-[#E9E9E9] disabled:text-[#9E9E9E]" type="button">
                            Verify
                        </button>
                    </div>
                </div>
