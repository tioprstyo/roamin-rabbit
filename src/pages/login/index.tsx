        ...
        <div className='main-wrapper max-w-screen-md mx-auto'>
            ...
            <div className='content-wrapper p-4'>
                ...
                <div className='form-content mt-11'>
                    ...
                    <div className="form">
                        <button onClick={Login} className="bg-[#FFEC69] color-[#000000] font-extrabold uppercase text-sm px-4 py-4 rounded-[9px] mr-1 mb-1 w-full text-[14px]" type="button">
                            Login
                        </button>
                    </div>
                </div>
                <div className="registrer mt-16 text-center">
                    <span className='text-sm font-medium'>Don’t have an account? <Link to="register" className='text-[#538EB6]'>Register</Link></span>
                </div>
            </div>
        </div>
    </>
