...
const MActivate = () => {
  ...
  const copyAddress = () => {
    const copyText = addressRef.current?.textContent;
    const isCopy = copy(copyText as string);
                  ...
                  >
                    <div className='warning-section'>
                      <div className='warning-wrapper p-4 border border-[#FFEC69] rounded-[9px] flex justify-between'>
                        <SimCardAlertOutlinedIcon
                          sx={{ fontSize: 60, color: '#FFEC69' }}
                        />
                        <p className='text-xs font-normal text-[#FFEC69]'>
                          <b className='font-extrabold'>WARNING!</b>
                          eSIM can only be installed once!{' '}
                          <b className='font-extrabold'>DO NOT</b> delete eSIM
                          from your device, you cannot install it again or to
                          top up your eSIM in the future
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='qr-section mt-4 p-4'>
                      <div className='qr text-center mb-4 dark:text-white'>
                        <h6 className='text-base font-black mb-4'>
                          SCAN THIS QR
                        </h6>
                      ...
                      <div className='download grid grid-cols-4 gap-3 items-end p-2'>
                        <div className='form col-span-3'>
                          <button
                            ...
                            className='bg-[#FFEC69] color-[#000000] font-extrabold uppercase text-sm px-3 py-3.5 rounded-[9px] w-full text-[14px] border border-[#FFEC69]'
                            type='button'
                          >
                            Download
                          </button>
                        ...
                        <div className='form'>
                          <button
                            className='bg-[#FFEC69] color-[#000000] font-extrabold uppercase text-sm px-3 py-3 rounded-[9px] w-full text-[14px] border border-[#FFEC69]'
                            type='button'
                          >
                            <ShareOutlinedIcon />
                          </button>
                        ...
                        <div className='cardContent flex justify-between items-center px-3 py-3'>
                          <div className='caption mr-3'>
                            ...
                            <p
                              ...
                              className='text-[12px] font-medium break-all'
                            >
                              {data?.activationCode}
                            </p>
                          </div>
                      ...
                      <div className='card'>
                        <div className='cardContent flex justify-between items-center px-3 py-3'>
                          ...
                          <p className='text-[12px] font-medium ml-3'>
                            Copy Paste the SM-DP+ ADDRESS & ACTIVATION CODE,
                            when you choose add data/mobile plan manually.
                          </p>
                        </div>
                      </div>
                    </div>
