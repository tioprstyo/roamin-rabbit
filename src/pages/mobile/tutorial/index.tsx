                                            ...
                                            <div>
                                                <div className="image-wrapper-slider">
                                                    <div className="main-image text-center">
                                                        <img className='mx-auto mb-4' src={AndroidImage} alt={AndroidImage} />
                                                        <h3 className='text-lg font-black mt-4'>Turn on Your eSIM</h3>
                                                    </div>
                                                    <div className="list-tutorial p-5">
                                                        <ol className='list-disc list-outside text-sm font-normal mb-4'>
                                                            <li>Go to “Settings” and tap “Connections”, thentap “SIM card manager” on your device .</li>
                                                            <li>Tap “Add mobile plan/Add eSIM”, then tap “Scan carrier QR CODE”</li>
                                    ...
                                    {openTab == 2 &&
                                        <Slider {...settings}>
                                            <div>
                                                <div className="image-wrapper-slider">
                                                    <div className="main-image text-center">
                                                        <img className='mx-auto mb-4' src={IosImage} alt={IosImage} />
                                                        <h3 className='text-lg font-black mt-4'>Turn on Your eSIM</h3>
                                                    </div>
                                                    <div className="list-tutorial p-5">
                                                        <ol className='list-disc list-outside text-sm font-normal mb-4'>
