    ...
    return (
      <div className='w-full min-h-screen bg-white dark:bg-roamin-dark-800 dark:text-white p-4'>
        ...
        <div className='mt-10 flex justify-center flex-col text-center items-center'>
          ...
          <button
            className='w-full bg-roamin-yellow-500 text-black p-4 rounded-[9px] text-lg font-extrabold'
    ...
    return (
      <div className='w-full min-h-screen bg-white dark:bg-roamin-dark-800 dark:text-white p-4'>
        ...
        <div className='mt-10 flex justify-center flex-col text-center items-center'>
          ...
          <p className='text-lg font-extrabold mb-8'>Failed Transaction</p>
          <p className='text-sm font-normal mb-20'>
            Your payment with using a credit card was unsuccessful. Try to buy
            again or purchase by using a different payment method.
          </p>
          <button className='w-full bg-roamin-yellow-500 text-black p-4 rounded-[9px] text-lg font-extrabold'>
            Try Again
          </button>
        </div>
      </div>
      ...
      <>
        <div className='w-full min-h-screen bg-white dark:bg-roamin-dark-800 dark:text-white p-4'>
          ...
          <div className='mt-10 flex justify-center flex-col text-center items-center'>
            ...
            <p className='text-sm font-normal mb-8'>
              You can make another order to enjoy a package plan that you
              needed.
            </p>
            <a
              href='/'
